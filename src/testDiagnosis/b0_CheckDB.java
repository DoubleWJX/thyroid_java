...
public class b0_CheckDB {
	...
	public static void mainmain() {
		...
		String dbPath = Configuration.dataDir_target + dbNameAfter;
	...
	public static void findImages(){
	    ...
	    try {
	      ...
	      c = DriverManager.getConnection("jdbc:sqlite:" + Configuration.dataDir_target + dbName);
	      c.setAutoCommit(false);

	      cto = DriverManager.getConnection("jdbc:sqlite:" + Configuration.dataDir_target + dbNameAfter);
